<tr>
	...
	<td>
		<div>
			<input class="model" type="checkbox" checked name="<?php echo $name ?>[model][hasMany]" value="true" id="<?php echo $name ?>[model][hasMany]" />
			<label for="<?php echo $name ?>[model][hasMany]">hasMany</label>
		</div>
		<div>
			<input class="model" type="checkbox" checked name="<?php echo $name ?>[model][belongsTo]" value="true" id="<?php echo $name ?>[model][belongsTo]" />
