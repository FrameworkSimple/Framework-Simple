...
<body>
	...
	<nav>
		<?php if(Session::get('AdminUser')): ?>
			<a href="<?php echo Asset::createUrl('AdminPanelSettings','index') ?>">Settings Setup</a>
			<a href="<?php echo Asset::createUrl('AdminPanelScaffolding','index') ?>">Scafolding</a>
			<a href="<?php echo Asset::createUrl('AdminPanelMigrations','index') ?>">Migrations</a>
			<a href="<?php echo Asset::createUrl('AdminPanelUser','logout')?>">Logout</a>
		<?php endif;?>
	</nav>
